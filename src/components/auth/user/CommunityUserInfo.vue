      ...
      <van-row class="rowBox">
        ...
        <van-col span="16 infoBox">
          ...
          <van-row class="lineBox">
            ...
            <van-col span="24">
              <van-button plain type="info" @click="showPopup(userInfo.userId)">{{userInfo.periodNumber}} / {{userInfo.buildingNumber}} / {{userInfo.unitNumber}} / {{userInfo.layerNumber}} / {{userInfo.householdNumber}}</van-button>
            </van-col>
          </van-row>
        </van-col>
      </van-row>
